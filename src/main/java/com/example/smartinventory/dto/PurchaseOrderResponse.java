...
public record PurchaseOrderResponse(
        ...
        @Schema(description = "When the goods are expected to arrive, or null when the order names no date and "
        ...
        @Schema(description = "The day the last of the goods arrived, or null while any of them are still to "
                + "come", example = "2026-09-11")
