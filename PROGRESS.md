...
**Working:** #82 — Basic dashboard endpoints (PR open), #84 — CSV export (PR open)
**Next up:** Pick next Future Improvement from ROADMAP.md (Excel/PDF export, rate limiting/audit logging, etc.)
